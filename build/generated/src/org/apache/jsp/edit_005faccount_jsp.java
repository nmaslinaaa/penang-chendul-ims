...
public final class edit_005faccount_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    if (currentUser == null) {
      ...
      out.write("    \n");
      out.write("    <script>\n");
      out.write("        let isFormDirty = false;\n");
      out.write("        let clickedLinkUrl = \"\"; // To store the clicked link's URL\n");
      out.write("\n");
      out.write("        function trackFormChanges() {\n");
      ...
      out.write("                    isFormDirty = true;\n");
      out.write("                });\n");
      out.write("            });\n");
      out.write("        }\n");
      out.write("\n");
      out.write("        function warnBeforeNavigate(event) {\n");
      out.write("    if (isFormDirty) {\n");
      out.write("        event.preventDefault(); // Prevent navigation\n");
      out.write("        clickedLinkUrl = event.target.href; // Store the clicked link's URL\n");
      out.write("        $('#unsavedChangesModal').modal('show'); // Show the modal\n");
      out.write("\n");
      out.write("        // Remove this line to avoid showing the URL in the modal\n");
      out.write("        // document.querySelector('#clickedLinkUrl').textContent = clickedLinkUrl;\n");
      out.write("\n");
      out.write("        // Add an event listener to continue navigation when user confirms\n");
      out.write("        document.querySelector('#confirmLeaveBtn').onclick = function () {\n");
      out.write("            isFormDirty = false; // Reset the flag\n");
      out.write("            window.location.href = clickedLinkUrl; // Redirect to the stored URL\n");
      out.write("        };\n");
      out.write("    }\n");
      out.write("}\n");
      out.write("\n");
      out.write("        function attachSidebarListeners() {\n");
      out.write("            const sidebarLinks = document.querySelectorAll('.sidebar a');\n");
      out.write("            sidebarLinks.forEach(link => {\n");
      out.write("                link.addEventListener('click', warnBeforeNavigate);\n");
      out.write("            });\n");
      out.write("        }\n");
      out.write("\n");
      out.write("        document.addEventListener('DOMContentLoaded', () => {\n");
      out.write("            trackFormChanges();\n");
      out.write("            attachSidebarListeners();\n");
      out.write("        });\n");
      out.write("    </script>\n");
      out.write("\n");
      out.write("</head>\n");
      ...
      out.write("                    <form method=\"post\" action=\"edit_account\" class=\"clearfix\">\n");
      ...
      out.write("                            <a href=\"change_password\" title=\"change password\" class=\"btn btn-danger pull-right\">Change Password</a>\n");
      ...
      out.write("</div>\n");
      out.write("\n");
      out.write("<!-- Modal for Unsaved Changes -->\n");
      out.write("<div class=\"modal fade\" id=\"unsavedChangesModal\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"unsavedChangesModalLabel\">\n");
      out.write("    <div class=\"modal-dialog\" role=\"document\">\n");
      out.write("        <div class=\"modal-content\">\n");
      out.write("            <div class=\"modal-header\">\n");
      out.write("                <h4 class=\"modal-title\" id=\"unsavedChangesModalLabel\">Unsaved Changes</h4>\n");
      out.write("            </div>\n");
      out.write("            <div class=\"modal-body\">\n");
      out.write("                You have unsaved changes. Are you sure you want to leave this page without saving?\n");
      out.write("            </div>\n");
      out.write("            <div class=\"modal-footer\">\n");
      out.write("                <button type=\"button\" class=\"btn btn-default\" data-dismiss=\"modal\">Cancel</button>\n");
      out.write("                <button type=\"button\" class=\"btn btn-primary\" id=\"confirmLeaveBtn\">Leave Page</button>\n");
      out.write("            </div>\n");
      out.write("        </div>\n");
      out.write("    </div>\n");
      out.write("</div>\n");
